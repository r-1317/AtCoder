...
def main():
  ...
  while True:
    ...
    if random.random() < 0.01:
      print(math.exp((initial_path_length - max_score) / temprature), file=sys.stderr)
      print(f"温度: {temprature}", file=sys.stderr)

    if max_score < initial_path_length or random.random() < math.exp((initial_path_length - max_score) / temprature):
