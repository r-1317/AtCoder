#!/usr/bin/env python3
"""train03.rs が出力した *.model.json (int8+scale+base64) から、提出用の g03.py を生成する。

Usage:
  python3 export-g03.py --model trained_best_v3.model.json --out g03.py
...
- 特徴量は GA-plan-v3.md に合わせて 501次元
"""
...
def main() -> None:
    ...
    ap.add_argument("--out", type=str, default="g03.py")
    args = ap.parse_args()
    ...
    if payload.get("format") != "ahc061-nn-i8-b64-v3":
